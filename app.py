...
class VoiceChatServer:
    ...
    async def handle_key_exchange(self, websocket, data):
        ...
        try:
            ...
            # Lưu khóa phiên cho cả hai client
            ...
            # Ký siêu dữ liệu bằng khóa bí mật của người gửi
            private_key = self.clients[websocket]['private_key']
            h = SHA256.new(metadata.encode())
            signature = pkcs1_15.new(private_key).sign(h)
            
            # Mã hóa khóa DES bằng khóa công khai của người nhận
